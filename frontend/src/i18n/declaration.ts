...
export enum I18nKey {
  ...
  HOME$LOAD_ONBOARDING_PLUGIN_TITLE = "HOME$LOAD_ONBOARDING_PLUGIN_TITLE",
  HOME$LOAD_ONBOARDING_PLUGIN_DESCRIPTION = "HOME$LOAD_ONBOARDING_PLUGIN_DESCRIPTION",
  BUTTON$LOAD_PLUGIN = "BUTTON$LOAD_PLUGIN",
  BUTTON$NO_THANKS = "BUTTON$NO_THANKS",
}
