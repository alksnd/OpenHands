...
export enum I18nKey {
  ...
  SETTINGS$OPENAI_COMPATIBLE_MODEL_HELP = "SETTINGS$OPENAI_COMPATIBLE_MODEL_HELP",
  SETTINGS$OPENAI_COMPATIBLE_BASE_URL_HELP = "SETTINGS$OPENAI_COMPATIBLE_BASE_URL_HELP",
