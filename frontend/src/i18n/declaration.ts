...
export enum I18nKey {
  ...
  SETTINGS$SKILLS_REPO_TITLE = "SETTINGS$SKILLS_REPO_TITLE",
  SETTINGS$SKILLS_REPO_DESCRIPTION = "SETTINGS$SKILLS_REPO_DESCRIPTION",
  SETTINGS$SKILLS_REPO_URL_LABEL = "SETTINGS$SKILLS_REPO_URL_LABEL",
  SETTINGS$SKILLS_REPO_PINNED_COMMIT = "SETTINGS$SKILLS_REPO_PINNED_COMMIT",
  SETTINGS$SKILLS_REPO_UPDATED = "SETTINGS$SKILLS_REPO_UPDATED",
  SETTINGS$SKILLS_REPO_UPDATE = "SETTINGS$SKILLS_REPO_UPDATE",
  SETTINGS$SKILLS_REPO_REMOVE = "SETTINGS$SKILLS_REPO_REMOVE",
