...
export enum I18nKey {
  ...
  AZURE_DEVOPS$WEBHOOK_MANAGER_NO_RESOURCES = "AZURE_DEVOPS$WEBHOOK_MANAGER_NO_RESOURCES",
  AZURE_DEVOPS$WEBHOOK_COLUMN_REPOSITORY = "AZURE_DEVOPS$WEBHOOK_COLUMN_REPOSITORY",
