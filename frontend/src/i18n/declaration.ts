...
export enum I18nKey {
  ...
  SETTINGS$CUSTOM_LLM_PROVIDER = "SETTINGS$CUSTOM_LLM_PROVIDER",
  SETTINGS$LLM_PROFILE_NAME = "SETTINGS$LLM_PROFILE_NAME",
  SETTINGS$LLM_PROFILE_NAME_HELP = "SETTINGS$LLM_PROFILE_NAME_HELP",
  ...
  SETTINGS$PROFILE_UNAVAILABLE_TOOLTIP = "SETTINGS$PROFILE_UNAVAILABLE_TOOLTIP",
